...
namespace Testbed.Render
{
    public class GLRenderLines
    {
        ...
        public void Flush()
        {
            ...
            GL.BindBuffer(BufferTarget.ArrayBuffer, _vboIds[0]);
            GL.BufferSubData(BufferTarget.ArrayBuffer, (IntPtr)0, _count * 8, _vertices);

            GL.BindBuffer(BufferTarget.ArrayBuffer, _vboIds[1]);
            GL.BufferSubData(BufferTarget.ArrayBuffer, (IntPtr)0, _count * 16, _colors);
