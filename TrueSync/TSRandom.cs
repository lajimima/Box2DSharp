...
namespace TrueSync
{
    ...
    public class TSRandom
    {
        ...
        public static TSRandom New(uint seed)
        {
            TSRandom r = new TSRandom(seed);
            return r;
        }
        ...
        {
            FP temp1 = ((FP)minValue) * 1000;
            int minValueInt = temp1.AsInt();

            FP temp2 = ((FP)maxValue) * 1000;
        ...
        {
            return Range(minValue.AsFloat(), maxValue.AsFloat());
        }
