...
namespace TrueSync
{
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP>
    {
        ...
        public static readonly FP V90 = 90;
        ...
        public static readonly FP DegRadRatio = new FP(180);
        public static readonly FP Deg2Rad = Pi / DegRadRatio;
        public static readonly FP HalfDeg2Rad = Deg2Rad * Half;

        public static readonly FP Rad2Deg = DegRadRatio / Pi;

        public static readonly FP LutInterval = (FP)(LUT_SIZE - 1) / PiOver2;

        public static readonly FP E = new FP(0x2B7E15162);
        ...
        public static FP Abs(FP value)
        {
            ...
            FP fp;
            fp._serializedValue = (value._serializedValue + mask) ^ mask;
            return fp;
        }
        ...
        {
            FP p;
            p._serializedValue = x._serializedValue + y._serializedValue;
            return p;
        ...
        {
            FP fp;
            fp._serializedValue = x._serializedValue % y._serializedValue;
            return fp;
            //return new FP(x._serializedValue % y._serializedValue);
        }
        ...
        {
            if (x._serializedValue == MIN_VALUE)
            {
                return MaxValue;
            }
            else
            {
                FP fp;
                fp._serializedValue = -x._serializedValue;
                return fp;
            }
        ...
        public static FP Sqrt(FP x)
        {
            ...
            FP fp;
            fp._serializedValue = (long)result;
            return fp;
        ...
        public static FP Acos(FP value)
        {
            ...
            var indexError = FastSub(rawIndex, roundedIndex);
            FP nearestValue;
            nearestValue._serializedValue = AcosLut[(int)roundedIndex];
            ...
            FP secondNearestValue;
            secondNearestValue._serializedValue = AcosLut[nextIndex];

            var delta = FastMul(indexError, FastAbs(FastSub(nearestValue, secondNearestValue)))._serializedValue;
            FP interpolatedValue;
            interpolatedValue._serializedValue = nearestValue._serializedValue + delta;
        ...
        {
            FP fp;
            fp._serializedValue = (long)(value * ONE);
            return fp;
        ...
        {
            if (value1._serializedValue > value2._serializedValue)
            {
                return value2;
            }
        ...
        public static FP Max(FP _value1, FP _value2)
        {
            if (_value1._serializedValue > _value2._serializedValue)
            {
                return _value1;
            }
        ...
        public static FP Lerp(FP from, FP to, FP percent)
        {
        ...
        {
            value = (value._serializedValue > ONE) ? One : value;
            value = (value._serializedValue < 0) ? Zero : value;
            return value;
        }
        public static FP Clamp(FP value, FP min, FP max)
        {
            value = (value._serializedValue > max._serializedValue) ? max : value;
            value = (value._serializedValue < min._serializedValue) ? min : value;
            return value;
        }
        #endregion
    }
