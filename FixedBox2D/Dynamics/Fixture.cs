...
namespace FixedBox2D.Dynamics
{
    ...
    public class Fixture : IDisposable
    {
        ...
        public FP Density
        {
            ...
            set
            {
                Debug.Assert(value.IsValid() && value >= FP.Zero);
                _density = value;
            }
        }
        ...
        public bool TestPoint(in TSVector2 p)
        {
    ...
    public struct FixtureDef
    {
        ...
        public FP RestitutionThreshold
        {
            get => _restitutionThreshold.GetValueOrDefault(FP.One * Settings.LengthUnitsPerMeter);
